            ...
            <div class="space-y-8 opacity-0 animate-fade-in-left" style="animation-delay: 0.2s;">
                ...
                <div class="space-y-4">
                    ...
                    <p class="text-xl text-gray-600 leading-relaxed max-w-2xl">
                        Desenvolvedor web com criação de sites responsivos
                        (Site para visualização simples, como exemplo)
                    </p>
                </div>
            ...
            <div class="space-y-8">
                <div class="space-y-4">
                    ...
                    <h2 class="text-4xl lg:text-5xl font-bold text-gray-900">
                        Com conhecimento em <span class="text-gradient">desenvolvimento web</span>
                    </h2>
                    
                    <p class="text-lg text-gray-600 leading-relaxed">
                        Experiencia de epoca de faculdade, e querendo melhorar todo dia
                    </p>
                    
                    <p class="text-lg text-gray-600 leading-relaxed">
                       Tenho como objetivos crescer na are aque estudei, formado pela Fatec em gestão da tecnologia da informação, 
                       buscando melhorar
                    </p>
                </div>
